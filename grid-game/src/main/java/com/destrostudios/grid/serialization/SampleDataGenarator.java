...
public class SampleDataGenarator {
    ...
    public static void initTestCharacter(EntityData data, String charackterName) {
        ...
        addDmgSpell(data, rand, attackPoints, spell, SpellAreaShape.LINE);
        spells.add(spell);
    ...
    private static void addDmgSpell(EntityData data, Random rand, int attackPoints, int spell, SpellAreaShape indicator) {
