...
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, property = "component")
@JsonSubTypes({
  @JsonSubTypes.Type(value = VisionComponent.class, name = "VisionComponent"),
  @JsonSubTypes.Type(value = CastsPerTurnComponent.class, name = "CastsPerTurnComponent"),
  @JsonSubTypes.Type(value = LifespanBuffComponent.class, name = "LifespanBuffComponent"),
  @JsonSubTypes.Type(value = SummonComponent.class, name = "SummonComponent"),
  @JsonSubTypes.Type(value = SummonCastComponent.class, name = "SummonCastComponent"),
  @JsonSubTypes.Type(value = ActiveSummonsComponent.class, name = "ActiveSummonsComponent"),
  @JsonSubTypes.Type(value = LifeSpanComponent.class, name = "LifeSpanComponent"),
  ...
  @JsonSubTypes.Type(
      value = AttackPointsPerTurnComponent.class,
      name = "AttackPointsPerTurnComponent"),
  @JsonSubTypes.Type(
      value = MovementPointsPerTurnComponent.class,
      name = "MovementPointsPerTurnComponent"),
  ...
  @JsonSubTypes.Type(
      value = AttackPointResistanceComponent.class,
      name = "AttackPointResistanceComponent"),
  @JsonSubTypes.Type(
      value = MovementPointResistanceComponent.class,
      name = "MovementPointResistanceComponent"),
