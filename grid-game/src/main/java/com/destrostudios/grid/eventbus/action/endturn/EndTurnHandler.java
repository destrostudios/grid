...
public class EndTurnHandler implements EventHandler<EndTurnEvent> {
    ...
    public void onEvent(EndTurnEvent event, Supplier<EntityData> entityDataSupplier) {
        ...
        MaxAttackPointsComponent maxAp = entityData.getComponent(currentEntity, MaxAttackPointsComponent.class);
        MaxMovementPointsComponent maxMp = entityData.getComponent(currentEntity, MaxMovementPointsComponent.class);
