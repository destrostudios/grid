...
public class ModelSkin {
    ...
    private void loadFile(String filePath) {
        try {
            ...
            System.err.println("Error while loading object skin '" + filePath + "': " + ex.getMessage());
        }
    }
            ...
            for (int i = 0; i < materialElements.size(); i++){
                ...
                if (material != null) {
                    ...
                    try {
                        ...
                        System.err.println("Error while reading material for object '" + name + "': " + ex.getMessage());
                    }
                }
            }
        }
