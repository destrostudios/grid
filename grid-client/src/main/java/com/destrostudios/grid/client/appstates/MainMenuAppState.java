...
public class MainMenuAppState extends MenuAppState {
    ...
    public void recreateMenu() {
        ...
        btnSettings.setLocalTranslation(settingsMargin, settingsMargin + settingsIconSize, 0);
        ...
        btnSettings.addCommands(Button.ButtonAction.Up, source -> openMenu(SettingsMenuAppState.class));
